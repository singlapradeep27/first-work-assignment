...
describe("formReducer", () => {
  it("sets fields", () => {
    ...
    const action: { type: "SET_FIELDS"; payload: FormField[] } = {
      type: "SET_FIELDS",
      payload: fields,
    };
  ...
  it("adds a field", () => {
    ...
    const action: { type: "ADD_FIELD"; payload: FormField } = {
      type: "ADD_FIELD",
      payload: field,
    };
  ...
  it("updates a field", () => {
    ...
    const action: {
      type: "UPDATE_FIELD";
      payload: { field: FormField; id: string };
    } = { type: "UPDATE_FIELD", payload: { field: updatedField, id: "1" } };
  ...
  it("removes a field", () => {
    ...
    const action: { type: "REMOVE_FIELD"; payload: string } = {
      type: "REMOVE_FIELD",
      payload: "1",
    };
    ...
    expect(newState.fields).not.toContainEqual(
